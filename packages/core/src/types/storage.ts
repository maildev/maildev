import type { Email, EmailSummary } from './email.js'
...
export interface Storage {
  ...
  /**
   * Get a page of email summaries — same as {@link Storage.list} but without
   * the message bodies, which is what a list view actually needs
   * @param options - Pagination, sorting and search options
   */
  listSummaries(options?: ListOptions): Promise<ListResult<EmailSummary>>
