...
mailServer.disableJavascript = false
...
mailServer.getEmail = function (id, done) {
  ...
  if (email) {
    if (email.html && this.disableJavascript) {
...
mailServer.isJavascriptDisabled = function () {
  return this.disableJavascript
}

mailServer.setDisableJavascript = function () {
