# CLI & configuration
Source: https://maildev.github.io/maildev/docs/reference/cli/
Section: Reference
...
See [HTTPS & TLS](https://maildev.github.io/maildev/docs/guides/https/) for the certificate flags in context.
...
reverse proxy — see [HTTPS & TLS](https://maildev.github.io/maildev/docs/guides/https/) for an nginx example,
...
[`POST /api/email/:id/relay`](https://maildev.github.io/maildev/docs/reference/rest-api/).
...
See [the MCP guide](https://maildev.github.io/maildev/docs/ai/mcp/) for client configuration, and the standalone
